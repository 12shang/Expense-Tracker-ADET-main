...
from expense_tracker import icon
from progress1 import Ui_MainWindow
...
icon = QtGui.QIcon()
icon.addPixmap(QtGui.QPixmap("/Users/trish/Desktop/ADET/venv/icons/image.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
