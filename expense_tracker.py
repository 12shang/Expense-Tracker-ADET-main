...
# SAVE ICON
icon = QIcon()
icon.addPixmap(QPixmap("/Users/trish/Desktop/ADET/venv/icons/save.png"), QIcon.Normal, QIcon.Off)
save.setIcon(icon)
...
# CLEAR ICON
icon1 = QIcon()
icon1.addPixmap(QPixmap("/Users/trish/Desktop/ADET/venv/icons/eraser.png"), QIcon.Normal, QIcon.Off)
clear.setIcon(icon1)
...
# EXIT ICON
icon2 = QIcon()
icon2.addPixmap(QPixmap("/Users/trish/Desktop/ADET/venv/icons/error.png"), QIcon.Normal, QIcon.Off)
exit.setIcon(icon2)
exit.setObjectName("exit")

# AMOUNT LABEL
totalamount_2 = QLabel(parent=window)
totalamount_2.setGeometry(820, 480, 171, 31)
...
# TOTAL ICON
icon3 = QIcon()
icon3.addPixmap(QPixmap("/Users/trish/Desktop/ADET/venv/icons/total.png"), QIcon.Normal, QIcon.Off)
total.setIcon(icon3)
...
# UPDATE ICON
icon4 = QIcon()
icon4.addPixmap(QPixmap("/Users/trish/Desktop/ADET/venv/icons/reload.png"), QIcon.Normal, QIcon.Off)
...
# DELETE ICON
icon5 = QIcon()
icon5.addPixmap(QPixmap("/Users/trish/Desktop/ADET/venv/icons/delete.png"), QIcon.Normal, QIcon.Off)
...
totalamount.setGeometry(650, 480, 171, 31)
...
print.setText("Print")
print.setGeometry(680, 540, 181, 51)
...
# PRINT ICON
icon6 = QIcon()
icon5.addPixmap(QPixmap("/Users/trish/Desktop/ADET/venv/icons/print.png"), QIcon.Normal, QIcon.Off)
print.setIcon(icon6)
